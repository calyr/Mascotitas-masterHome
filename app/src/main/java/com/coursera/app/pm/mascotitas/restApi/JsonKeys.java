...
public final class JsonKeys {
    ...
    public static final String OUTGOING                          = "outgoing_status";
    public static final String TARGET_USER                          = "target_user_is_private";
    public static final String INCOMING                         = "incoming_status";
}
